...
- `ingest_live_transcript` polls an external Open Granola (or compatible) SQLite DB or an NDJSON/`watch_dir` fixture into `log_transcript`. Open Granola is not vendored; WASAPI capture stays outside 2d6mcp.
